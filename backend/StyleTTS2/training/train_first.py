...
from core.meldataset import build_dataloader
...
def main(config_path):
    """
    Main function for the first stage of training the StyleTTS 2 model.
    ...
    with accelerator.main_process_first():
        ...
        # load BERT model
        from core.Utils.PLBERT.util import load_plbert
            ...
            if epoch % saving_epoch == 0:
                ...
                if accelerator.is_main_process:
                    ...
                    for f in os.listdir(log_dir):
                        if f.startswith('epoch_1st_'):
                            os.remove(osp.join(log_dir, f))
                    
                    accelerator.save_state(osp.join(log_dir, 'epoch_1st_latest.pth'))
